...
# import random
import pygame
from pygame.locals import QUIT, KEYDOWN, K_u, MOUSEMOTION, MOUSEBUTTONDOWN, MOUSEBUTTONUP
...
class GUI2D:
    ...
    def draw(self):
        ...
        for row in range(len(self.labyrinth)):
            for col in range(len(self.labyrinth[row])):
                ...
                y = (HEIGHT + FRAME - len(self.labyrinth) * BLOCKSIZE) / 2 + row * BLOCKSIZE
    ...
    def run(self):
        ...
        while running:
            ...
            # draw panel
            pygame.draw.rect(self.screen, GRAY, (WIDTH - self.currentSize, -2, 10+self.currentSize, HEIGHT+4), border_radius=40)
